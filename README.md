...
Opus 48 kbps preview MP3s for the **new-age** sample library.
...
- **Files**: 16 Opus previews
- **Bitrate**: 48 kbps VBR
- **Container**: Ogg Opus (.opus)
- **Source**: [`zulfikarbarbora-outl/new-age`](https://github.com/zulfikarbarbora-outl/new-age)
- **Branch**: `main`

## URL pattern

```
https://raw.githubusercontent.com/zulfikarbarbora-outl/new-age-opus-48/main/<filename>.opus
```
